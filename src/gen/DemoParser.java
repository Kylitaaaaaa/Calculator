...
public class DemoParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, NUMBER=6, DEC=7, OPENPAREN=8, 
		CLOSEPAREN=9;
	public static final int
	...
	private static final String[] _SYMBOLIC_NAMES = {
		null, null, null, null, null, null, "NUMBER", "DEC", "OPENPAREN", "CLOSEPAREN"
	};
	...
	public static class CodeContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DemoVisitor ) return ((DemoVisitor<? extends T>)visitor).visitCode(this);
	...
	public final CodeContext code() throws RecognitionException {
		...
		try {
			...
			while (_la==NUMBER || _la==OPENPAREN) {
				...
				{
				setState(4);
				((CodeContext)_localctx).mathC = math_expression(0);
				}
				}
				setState(9);
				_errHandler.sync(this);
	...
	private Math_expressionContext math_expression(int _p) throws RecognitionException {
		...
		try {
			...
			case OPENPAREN:
				...
				match(OPENPAREN);
				setState(14);
				((Math_expressionContext)_localctx).math = math_expression(0);
				setState(15);
				match(CLOSEPAREN);
				}
				break;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(22);
						((Math_expressionContext)_localctx).right = math_expression(4);
						}
						break;
					case 2:
						{
	...
	public static final String _serializedATN =
		...
		"\4\2\4\2\4\3\2\3\5\3\2\6\7\2#\2\t\3\2\2\2\4\24\3\2\2\2\6\b\5\4\3\2\7\6"+
		"\3\2\2\2\b\13\3\2\2\2\t\7\3\2\2\2\t\n\3\2\2\2\n\f\3\2\2\2\13\t\3\2\2\2"+
		"\f\r\7\2\2\3\r\3\3\2\2\2\16\17\b\3\1\2\17\20\7\n\2\2\20\21\5\4\3\2\21"+
		"\22\7\13\2\2\22\25\3\2\2\2\23\25\7\b\2\2\24\16\3\2\2\2\24\23\3\2\2\2\25"+
		"\36\3\2\2\2\26\27\f\5\2\2\27\30\t\2\2\2\30\35\5\4\3\6\31\32\f\4\2\2\32"+
		"\33\t\3\2\2\33\35\5\4\3\5\34\26\3\2\2\2\34\31\3\2\2\2\35 \3\2\2\2\36\34"+
		"\3\2\2\2\36\37\3\2\2\2\37\5\3\2\2\2 \36\3\2\2\2\6\t\24\34\36";
